...
public class InputErrorChecker {
	...
	public InputException validate(TokenizedCommand command) {
		...
		case "label":
			return label(arg);
		case "set-recurring":
			return setRecurring(arg);
		case "remove-recurring":
			return removeRecurring(arg);
		case "postpone":
			return postpone(arg);
		case "forward":
			return forward(arg);
		case "add-remind":
			return addRemind(arg);
		case "remind":
			return remind(arg);
		case "add-remind-bef":
			return addRemindBef(arg);
		case "remind-bef":
			return remindBef(arg);
		case "done":
			return done(arg);
		case "undone":
			return undone(arg);
	...
	private InputException undoneChecker(String string) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException doneChecker(String string) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException remindBefChecker(String name, String string, String string2) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException addRemindBefChecker(String string, String string2, String[] restOfArgs) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException remindChecker(String string) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException forwardChecker(String name, String string, String string2) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException postponeChecker(String name, String string, String string2) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException setRecurringChecker(String string, boolean b, String string2) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException labelChecker(String name, String string) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException sortChecker(String[] arg) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException filterChecker(String[] arg) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException searchChecker(String[] arg) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException editChecker(String name, String string, String string2) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException add(String[] arg) {
		String type = "null";
		if (arg.length == 0) {
	...
	private InputException addEvent(String[] arg) {
		if (arg.length != 6 && arg.length != 5) {
			...
			if (arg.length == 6) {
				...
				return addEventLessChecker(arg[1], arg[2], arg[3], arg[4]);
			}
		}
	}

	private InputException addDeadline(String[] arg) {
		if (arg.length != 4 && arg.length != 3) {
			...
			if (arg.length == 4) {
				...
				return addDeadlineLessChecker(arg[1], arg[2]);
			}
		}
	}

	private InputException addTask(String[] arg) {
		if (arg.length != 2) {
	...
	private InputException addRecurring(String[] arg) {
		switch (arg[1]) {
		case "event":
	...
	private InputException addRecurringEvent(String[] arg) {
		if (arg.length != 8 && arg.length != 7) {
			return new InputException("ADD RECURRING EVENT", "INCOMPLETE");
		} else {
			if (arg.length == 8) {
				return addRecurringEventChecker(arg[2], arg[3], arg[4], arg[5], arg[6], arg[7]);
			} else {
				return addRecurringEventLessChecker(arg[2], arg[3], arg[4], arg[5], arg[6]);
			}
		}
	}

	private InputException addRecurringDeadline(String[] arg) {
		if (arg.length != 6 && arg.length != 5) {
			return new InputException("ADD RECURRING DEADLINE", "INCOMPLETE");
		} else {
			if (arg.length == 6) {
				return addRecurringDeadlineChecker(arg[2], arg[3], arg[4], arg[5]);
			} else {
				return addRecurringDeadlineLessChecker(arg[2], arg[3], arg[4]);
			}
		}
	}

	private InputException edit(String[] arg) {
		if (arg.length != 3) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return editChecker(task.getName().getName(), arg[1], arg[2]);
				}
			} else {
				return editChecker(arg[0], arg[1], arg[2]);
			}
		}
	}

	private InputException delete(String[] arg) {
		if (arg.length != 1) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return deleteChecker(task.getName().getName());
				}
			} else {
				return deleteChecker(arg[0]);
			}
		}
	}

	private InputException search(String[] arg) {
		if (arg.length != 1) {
			return new InputException("SEARCH", "INCOMPLETE");
		} else {
			return searchChecker(arg);
		}
	}

	private InputException filter(String[] arg) {
		if (arg.length != 1) {
			return new InputException("FILTER", "INCOMPLETE");
		} else {
			return filterChecker(arg);
		}
	}

	private InputException sort(String[] arg) {
		if (arg.length != 2) {
			return new InputException("SORT", "INCOMPLETE");
		} else {
			return sortChecker(arg);
		}
	}

	private InputException label(String[] arg) {
		if (arg.length != 2) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return labelChecker(task.getName().getName(), arg[1]);
				}
			} else {
				return labelChecker(arg[0], arg[1]);
			}
		}
	}

	private InputException setRecurring(String[] arg) {
		if (arg.length != 2) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return setRecurringChecker(task.getName().getName(), true, arg[1]);
				}
			} else {
				return setRecurringChecker(arg[0], true, arg[1]);
			}
		}
	}

	private InputException removeRecurring(String[] arg) {
		if (arg.length != 2) {
			return new InputException("SET-RECURRING", "INCOMPLETE");
		} else {
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return removeRecurringChecker(task.getName().getName(), true, arg[1]);
				}
			} else {
				return removeRecurringChecker(arg[0], true, arg[1]);
			}
		}
	}

	private InputException postpone(String[] arg) {
		if (arg.length != 3) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return postponeChecker(task.getName().getName(), arg[1], arg[2]);
				}
			} else {
				return postponeChecker(arg[0], arg[1], arg[2]);
			}
		}
	}

	private InputException forward(String[] arg) {
		if (arg.length != 3) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return forwardChecker(task.getName().getName(), arg[1], arg[2]);
				}
			} else {
	...
	private InputException addRemind(String[] arg) {
		return addRemindChecker(arg);
	}

	private InputException remind(String[] arg) {
		if (arg.length != 1) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return remindChecker(task.getName().getName());
				}
			} else {
				return remindChecker(arg[0]);
			}
		}
	}

	private InputException addRemindBef(String[] arg) {
		String[] restOfArgs = new String[arg.length - 2];
		for (int i = 0; i < arg.length; i++) {
			restOfArgs[i] = arg[i + 2];
		}
		return addRemindBefChecker(arg[0], arg[1], restOfArgs);
	}

	private InputException remindBef(String[] arg) {
		if (arg.length != 3) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return remindBefChecker(task.getName().getName(), arg[1], arg[2]);
				}
			} else {
				return remindBefChecker(arg[0], arg[1], arg[2]);
			}
		}
	}

	private InputException done(String[] arg) {
		if (arg.length != 1) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return doneChecker(task.getName().getName());
				}
			} else {
				return doneChecker(arg[0]);
			}
		}
	}

	private InputException undone(String[] arg) {
		if (arg.length != 1) {
			...
			if (isInteger(arg[0])) {
				...
				if (task == null) {
					...
					return undoneChecker(task.getName().getName());
				}
			} else {
				return undoneChecker(arg[0]);
			}
		}
	}
	
	private InputException exit(String[] arg) {
		return exitChecker(arg);
	}

	private InputException exitChecker(String[] arg) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException addRemindChecker(String[] arg) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException removeRecurringChecker(String name, boolean b, String string) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException addRecurringDeadlineLessChecker(String string, String string2, String string3) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException addRecurringDeadlineChecker(String string, String string2, String string3, String string4) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException addRecurringEventLessChecker(String string, String string2, String string3, String string4,
			String string5) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException addRecurringEventChecker(String string, String string2, String string3, String string4,
			String string5, String string6) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException addTaskChecker(String string) {
		// TODO Auto-generated method stub
		return null;
	}

	private InputException addDeadlineLessChecker(String string, String string2) {
		return null;
		// TODO Auto-generated method stub

	}

	private InputException addDeadlineChecker(String string, String string2, String string3) {
		return null;
		// TODO Auto-generated method stub

	}

	private InputException addEventLessChecker(String string, String string2, String string3, String string4) {
		return null;
		// TODO Auto-generated method stub

	}

	private InputException addEventChecker(String string, String string2, String string3, String string4,
			String string5) {
		return null;
		// TODO Auto-generated method stub
	...
	private InputException deleteChecker(String name) {
		// TODO Auto-generated method stub
		return null;
	}
