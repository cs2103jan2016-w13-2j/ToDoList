...
public class DataBase {
    ...
    // helper method
    /*
    public Task convert_StringToTask(String taskStr) {
   ...
   */
    ...
    /**
     * This method search for and then return tasks from the database according to the command.
     * 
     * @param   command   command to search for the tasks in the database
     * @return  an arraylist of all the tasks in the search result; if the search result is empty, returns an empty arraylist
     */
    ...
    /**
     * This method returns the path of the local text file that stores all the tasks.
    ...
    /**
     * This method returns the name of the local text file that stores all the tasks.
     ...
     * @param order      the order of the task list after sorting, either in ascending order or descending order 
     */
